# -*- coding: utf-8 -*-
#
# Veritawall documentation build configuration file, created by
...
try:
    __repo__version = subprocess.check_output(
        ["git", "describe", "--always"], **subprocess_params)
...
htmlhelp_basename = 'Veritawalldoc'
...
latex_documents = [
    (master_doc, 'Veritawall.tex', u'Veritawall Documentation',
     u'Deciso B.V.', 'manual'),
]
...
man_pages = [
    (master_doc, 'veritawall', u'Veritawall Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Veritawall', u'',
     author, 'Veritawall', 'High-end security made easy.',
     'Miscellaneous'),
]
