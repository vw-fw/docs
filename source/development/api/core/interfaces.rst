...
.. csv-table:: Resources (LoopbackSettingsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Loopback.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Veritawall/Interfaces/Loopback.xml>`__"
...
.. csv-table:: Resources (VipSettingsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Vip.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Veritawall/Interfaces/Vip.xml>`__"
...
.. csv-table:: Resources (VlanSettingsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `Vlan.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Veritawall/Interfaces/Vlan.xml>`__"
...
.. csv-table:: Resources (VxlanSettingsController.php)
   ...
   :widths: 4, 15, 15, 30, 40
    ...
    "``<<uses>>``", "", "", "", "*model* `VxLan.xml <https://github.com/opnsense/core/blob/master/src/opnsense/mvc/app/models/Veritawall/Interfaces/VxLan.xml>`__"
