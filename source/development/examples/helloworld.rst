...
For all Veritawall modules and applications there are some basic style and
...
When creating modules for Veritawall, always name your components like
this: VendorName/ModuleName

In our sample case this will be: Veritawall/HelloWorld
...
models/Veritawall/HelloWorld directory.
...
.. code-block:: php
    :caption: /usr/local/veritawall/mvc/app/models/Veritawall/HelloWorld/HelloWorld.php

    <?php
    namespace Veritawall\HelloWorld;
     
    use Veritawall\Base\BaseModel;
     
...
.. code-block:: xml
    :caption: /usr/local/veritawall/mvc/app/models/Veritawall/HelloWorld/HelloWorld.xml

    <model>
        <mount>//Veritawall/helloworld</mount>
        <description>
            the Veritawall "Hello World" application
        </description>
        <items>
        </items>
    </model>
...
Create a template named index.volt inside the views/Veritawall/HelloWorld
directory containing the following data:


.. code-block:: html
    :caption: /usr/local/veritawall/mvc/app/views/Veritawall/HelloWorld/index.volt
...
Every Veritawall module should separate presentation from logic, that’s
...
in controllers/Veritawall/HelloWorld/ with the following name
IndexController.php and contents:

.. code-block:: php
    :caption: /usr/local/veritawall/mvc/app/controllers/Veritawall/HelloWorld/IndexController.php

    <?php
    namespace Veritawall\HelloWorld;
    class IndexController extends \Veritawall\Base\IndexController
    {
        public function indexAction()
        {
            // pick the template to serve to our users.
            $this->view->pick('Veritawall/HelloWorld/index');
        }
    }
...
.. code-block:: php
    :caption: /usr/local/veritawall/mvc/app/controllers/Veritawall/HelloWorld/Api/SettingsController.php

    <?php
    namespace Veritawall\HelloWorld\Api;
     
    use \Veritawall\Base\ApiControllerBase;
...
models/Veritawall/Base/FieldTypes directory. If specific field types
...
.. code-block:: xml
    :caption: /usr/local/veritawall/mvc/app/controllers/Veritawall/HelloWorld/forms/general.xml
...
.. code-block:: php
    ...
    use \Veritawall\HelloWorld\HelloWorld;
...
.. code-block:: php
    ...
    class SimplifiedSettingsController extends ApiMutableModelControllerBase
    {
        ...
        protected static $internalModelClass = 'Veritawall\HelloWorld\HelloWorld';
    }
...
and save our form, by using the Veritawall libraries you can validate your
data automatically.
...
::
    ...
    /usr/local/veritawall/service/templates/Veritawall/HelloWorld/
...
.. code-block:: html+jinja
    :caption: /usr/local/veritawall/service/templates/Veritawall/HelloWorld/helloworld.conf

    {% if helpers.exists('Veritawall.helloworld.general') and Veritawall.helloworld.general.Enabled|default("0") == "1" %}
    [general]
    SMTPHost={{ Veritawall.helloworld.general.SMTPHost|default("") }}
    FromEmail={{ Veritawall.helloworld.general.FromEmail|default("") }}
    ToEmail={{ Veritawall.helloworld.general.ToEmail|default("") }}
    Subject={{ Veritawall.helloworld.general.Description|default("") }}
    {% endif %}
...
controllers/Veritawall/HelloWorld/Api/ServiceController.php and add the
backend module to the use section, like this:

.. code-block:: php

    use \Veritawall\Core\Backend;
...
.. code-block:: php
    ...
    public function reloadAction()
    {
        ...
        if ($this->request->isPost()) {
            $backend = new Backend();
            $bckresult = trim($backend->configdRun("template reload Veritawall/HelloWorld"));
            if ($bckresult == "OK") {
                $status = "ok";
            }
        }
...
::
  ...
  configctl template reload Veritawall/HelloWorld
...
::
    ...
    /usr/local/veritawall/service/conf/actions.d/actions_helloworld.conf
...
::
    ...
    [test]
    command:/usr/local/veritawall/scripts/Veritawall/HelloWorld/testConnection.py
    parameters:
    type:script_output
...
Veritawall is available in may different languages like english, german or japanese.
...
.. Note::
    ...
    This makes plugins hard to translate and will decrease the quality of Veritawall in other languages.
...
.. code-block:: xml
    :caption: /usr/local/veritawall/mvc/app/models/Veritawall/HelloWorld/Menu/Menu.xml
...
.. code-block:: xml
    :caption: /usr/local/veritawall/mvc/app/models/Veritawall/HelloWorld/ACL/ACL.xml
...
All files are created in their original locations (on the Veritawall
...
https://github.com/veritawall/tools )
...
::
    ...
    src/veritawall/mvc/app/controllers/Veritawall/HelloWorld/Api/ServiceController.php
    src/veritawall/mvc/app/controllers/Veritawall/HelloWorld/Api/SettingsController.php
    src/veritawall/mvc/app/controllers/Veritawall/HelloWorld/Api/SimplifiedSettingsController.php
    src/veritawall/mvc/app/controllers/Veritawall/HelloWorld/IndexController.php
    src/veritawall/mvc/app/controllers/Veritawall/HelloWorld/forms/general.xml
    src/veritawall/mvc/app/models/Veritawall/HelloWorld/ACL/ACL.xml
    src/veritawall/mvc/app/models/Veritawall/HelloWorld/HelloWorld.php
    src/veritawall/mvc/app/models/Veritawall/HelloWorld/HelloWorld.xml
    src/veritawall/mvc/app/models/Veritawall/HelloWorld/Menu/Menu.xml
    src/veritawall/mvc/app/views/Veritawall/HelloWorld/index.volt
    src/veritawall/scripts/Veritawall/HelloWorld/testConnection.py
    src/veritawall/service/templates/Veritawall/HelloWorld/+TARGETS
    src/veritawall/service/templates/Veritawall/HelloWorld/helloworld.conf
    src/veritawall/service/conf/actions.d/actions_helloworld.conf
...
will be a standard pkg package, which you can install on any Veritawall
...
-  Veritawall architecture :doc:`Architecture <../architecture>`
-  Veritawall creating models
