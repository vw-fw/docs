...
The purpose of this example is to show how to build data grids in Veritawall, using the various components
...
.. code-block:: php
    :linenos:
    :caption: /usr/local/veritawall/mvc/app/models/Veritawall/GridExample/GridExample.php

    <?php
    namespace Veritawall\GridExample;
...
.. code-block:: xml
    ...
    :linenos:
    :caption: /usr/local/veritawall/mvc/app/models/Veritawall/GridExample/GridExample.xml

    <model>
        <mount>//Veritawall/GridExample</mount>
        <description>
            the Veritawall "GridExample" application
        </description>
        <items>
            <addresses>
...
the preinstalled types can be found in our field type directory on `GitHub <https://github.com/opnsense/core/tree/master/src/opnsense/mvc/app/models/Veritawall/Base/FieldTypes>`__.
...
.. code-block:: php
    :linenos:
    :caption: /usr/local/veritawall/mvc/app/controllers/Veritawall/GridExample/Api/SettingsController.php

    namespace Veritawall\GridExample\Api;

    use \Veritawall\Base\ApiMutableModelControllerBase;

    class SettingsController extends ApiMutableModelControllerBase
    {
        protected static $internalModelName = 'gridexample';
        protected static $internalModelClass = 'Veritawall\GridExample\GridExample';
...
.. code-block:: xml
    :caption: /usr/local/veritawall/mvc/app/controllers/Veritawall/GridExample/forms/dialogAddress.xml
...
.. code-block:: html
    :caption: /usr/local/veritawall/mvc/app/views/Veritawall/GridExample/index.volt
    :linenos:
...
.. code-block:: php
    :linenos:
    :caption: /usr/local/veritawall/mvc/app/controllers/Veritawall/GridExample/IndexController.php
    ...
    class IndexController extends \Veritawall\Base\IndexController
    {
        ...
        {
            $this->view->pick('Veritawall/GridExample/index');
