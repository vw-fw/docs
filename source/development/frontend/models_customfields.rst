...
.. code-block:: php
    ...
    use Veritawall\Base\FieldTypes\BaseField;
...
.. code-block:: xml
    ...
    <model>
        <mount>//Veritawall/MyFirst/App</mount>
...
.. Tip::
    ...
    Inspect the `basic field <https://github.com/opnsense/core/tree/master/src/opnsense/mvc/app/models/Veritawall/Base/FieldTypes>`__ types
    for inspiration, a concrete example of a custom field type can be found in the
    `firewall <https://github.com/opnsense/core/tree/master/src/opnsense/mvc/app/models/Veritawall/Firewall>`__ section
