...
All components that are using the full architecture of Veritawall
...
communication. Secrets are not stored on Veritawall and can be downloaded
...
Before you can start, make sure your Veritawall has a valid SSL
...
 
   ...
   if r.status_code == 200:
       ...
       if response['status'] == 'ok':
           print ('Veritawall can be upgraded')
