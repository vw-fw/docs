...
`Veritawall <https://opnsense.org/developers-invitation/>`__ and how you
...
built images on FreeBSD 10.1 when Veritawall was still running on FreeBSD 10.0.
...
Veritawall <https://github.com/opnsense/tools/blob/master/README.md>`__.

.. TIP::

  As of November 2015 Veritawall is equipped with a tool that can completely
  reinstall a running system in place for a thorough factory reset or to restore
  consistency of all the Veritawall files. It can also wipe the configuration
  directory, but won't do that by default.
  The `veritawall-bootstrap <https://github.com/opnsense/update>`__ script is
  particularly useful if you want to convert a hosted FreeBSD system to Veritawall.
...
and upgrades. Of course, at some point you will want to bring Veritawall
...
Although this is just a peek into Veritawall development workflow it brings to
...
The Veritawall core team looks forward to your feedback;
