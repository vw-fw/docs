...
base remains. As it stands today, Veritawall has evolved from being a fork to a whole new
...
----------------------------------
With Veritawall, we have restored a stable project with clear goals and a very simple
...
* Veritawall is now a package that can be installed on top of our custom FreeBSD
  build (you can literally do pkg remove veritawall and you are left with an almost
...
You are invited! Try Veritawall, be part of the community and help the project move
forward. Veritawall is rapidly becoming the number one open source firewall platform!
