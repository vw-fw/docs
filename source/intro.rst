...
Welcome to the Veritawall documentation & wiki project!
...
------------------------------------
Welcome to Veritawall's documentation!
------------------------------------
`Veritawall® <https://opnsense.org>`__ is an open source,
easy-to-use and easy-to-build FreeBSD based firewall and routing platform.

**Veritawall** includes most of the features available in expensive commercial
...
-----------------
  ...
  environment. Make Veritawall the most widely used open source security platform.
  The project’s name is derived from open and sense and stands for:
  “Open (source) makes sense.”


.. image:: ./images/Veritawall-Deciso-Screenshot.jpg
...
add a version selector in the documentation, but given Veritawall is a security product, we advise to keep it up to date
...
The next sections should be quite familiair when working with Veritawall, as they reflect the options in the
menu of the product. In case you're not yet used to Veritawall, you can always use the search input in the left corner of
...
When it comes to building software on top of Veritawall or extending existing functionality, the development
...
The feature set of Veritawall includes high-end features such as forward caching
...
newly developed MVC-framework based on Phalcon. Veritawall’s focus on security
brings unique features such as easy to use one time password authentication for various components.

The robust and reliable update mechanism gives Veritawall the ability to provide
important security updates in a timely fashion.

----------------------

----------------------
Veritawall Core Features
----------------------
