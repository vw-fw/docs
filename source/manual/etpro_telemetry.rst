...
The IDS/IPS available in Veritawall is based on Suricata.
This open source IDS/IPS engine has proven its value in Veritawall, especially in combination with the free Proofpoint ETOpen ruleset.

The need for valuable threat detection data and the increasing importance of additional network security
has brought Proofpoint and Veritawall together.
...
When you allow your Veritawall system to share anonymized information about detected threats - the alerts -
...
.. Note::
    ...
    When ET Pro Telemetry is activated, your Veritawall system sends data to Proofpoint. Proofpoint does not know who you are, they
...
.. Note::
    ...
    To use ET Pro Telemetry, you will need to have Veritawall 19.1 or higher installed. When using an older version,
...
Next step is to register your token in Veritawall and enable rulesets.
...
.. Note::
    ...
    All script code can be found in the following directory */usr/local/veritawall/scripts/ids_telemetry/*
...
Veritawall Version                         Current installed software version.  This will help both for troubleshooting purposes
