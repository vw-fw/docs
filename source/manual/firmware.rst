...
In the firmware section you can keep your Veritawall up to date and have the ability to install additional software.
...
Plugins are additional software packages that are available for Veritawall, usually they come with their own
...
.. Note::
    ...
    Upgrading to Veritawall BE is only possible when the installed community version number is lower than the
