...
This article explains the basics of the Veritawall Graphical User Interface or GUI
for short.
...
The default user is root and the password is veritawall.
...
Logo & Link to Lobby
---------------------
Click on the Veritawall logo wherever you are in the interface and you will be
...
Many components within Veritawall use grid views to navigate through content, below is an example of a simple table view
