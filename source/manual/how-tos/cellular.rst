...
===========================
Veritawall supports a wide range of USB and miniPCIe cellular modems that can be used
...
In general, Veritawall should support all cellular modems that are supported by the
...
.. Note::
  ...
  configuring the modem in Veritawall. There is little chance that you
...
consult the Veritawall support forum.
