...
All network hardware between Veritawall and the Media Receiver or TV Box must support IGMP snooping. Without IGMP snooping enabled, the network
...
Ensure you are running Veritawall 22.1 or later
