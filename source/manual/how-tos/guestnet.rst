...
.. image:: images/veritawall_hotspot_controller.png
    :width: 100%
...
either buy or obtain for free at the reception. Veritawall has built-in support for
...
Prerequisites
-------------
We will start configuration with a fresh Veritawall install, updated to the latest
...
------------------------
The template feature is one of the most powerful features of Veritawall's Captive
...
Logout. For this feature we will use Veritawall's built-in API calls.
...
-----------------------------
Veritawall has a very powerful CLI that is particularly useful for debugging purposes.
