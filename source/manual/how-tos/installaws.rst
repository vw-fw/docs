=============================
Installing Veritawall AWS image
=============================
...
Next go to "AWS Marketplace" and search "Veritawall". Our official image is sold via Deciso Sales B.V..
...
.. code-block::
    ...
    *** Veritawall.localdomain: Veritawall 21.7.7 (amd64/OpenSSL) ***
    ...
    FreeBSD/amd64 (Veritawall.localdomain) (ttyu0)
...
Login to Veritawall using the address provided.
