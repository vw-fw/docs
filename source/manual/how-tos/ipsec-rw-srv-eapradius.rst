==========================================
IPsec: Setup Veritawall for IKEv2 EAP-RADIUS
==========================================
...
set a shared secret, go to Veritawall UI to :menuselection:`System --> Access --> Servers` and add a new instance:
...
When you do not have an own Radius instance just use the Veritawall plugin and follow this guide:
:doc:`freeradius`
