===========================================
IPsec: Setup Veritawall for IKEv1 using XAuth
===========================================

.. contents:: Index

XAuth was an addition to IKEv1 supporting user authentication credentials additionally to
pre-shared keys or certificates. There are three different types supported by Veritawall which
...
========================== ======================= ========================================
  **Description**           IPsec Veritawall          *Freely chosen description*
...
========================== ======================= =============================
  **Name**                  IPsec Veritawall         *Freely chosen name*
  **Type**                  IPSec Xauth PSK        *As configured in Veritawall*
