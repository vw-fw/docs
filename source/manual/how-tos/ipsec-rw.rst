...
With this guide we will show you how to configure the server side on Veritawall with the different
...
.. csv-table:: VPN combinations
   :header: "VPN Method", "Win7", "Win10", "Linux", "Mac OS X", "IOS", "Android", "Veritawall config"
