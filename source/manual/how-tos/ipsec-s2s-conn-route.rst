...
This example utilises the new options available in Veritawall 23.1 to setup a site to site tunnel in routed mode
between two Veritawall machines using a pre shared key.
