...
working Veritawall installation and an Azure virtual network setup with a unique
...
Sample Setup
------------
This sample configuration uses an Veritawall box and the basic Azure virtual network
...
Enable IPsec for Veritawall, select:
...
**You are almost done configuring Veritawall (only some firewall settings remain, which will be addressed later).**
...
-------------------
=================================== ====================== ==================================================
**Name**                             lng.veritawall           *Freely chosen name*
**IP address**                       1.2.3.4                *The public IP address of your remote Veritawall*
...
-------------------
=================================== ====================== ==================================================
**Name**                             vpn.veritawall           *Freely chosen name*
**Connection type**                  Site-to-site (IPsec)
**Virtual network gateway**          vpn.gw                 *Select virtual network gateway*
**Local network gateway**            lng.veritawall           *Select local network gateway*
