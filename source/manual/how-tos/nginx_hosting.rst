...
.. Warning::
    ...
    Even if you can host websites directly from Veritawall, it is not recommended for security reasons - especially when
...
* Do not overlap nor use Veritawall directories as root
