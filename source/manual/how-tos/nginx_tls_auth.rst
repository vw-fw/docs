...
.. code-block:: none
    ...
    curl https://192.168.1.1:444/file.txt --cacert ../MyVeritawallCA.crt 
    <html>
...
.. code-block:: none
    ...
    curl https://192.168.1.1:444/file.txt --cert ../nginx_client_test_cert.crt --key ../nginx_client_test_cert.key --cacert ../MyVeritawallCA.crt
    Hello World
