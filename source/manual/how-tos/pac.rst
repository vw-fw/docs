...
Veritawall supports generating PAC files to provide automatic proxy configuration
...
.. Warning::
    When DNS is used, Veritawall must respond via HTTP on port 80.
...
Domain      your domain
Type        A or AAAA
IP          IP of your Veritawall (where the Web interface is reachable
Description can stay empty
=========== =========================================================
...
the Veritawall web interface on port 80 with HTTP. The following URL will be
created:
...
.. Warning::
    ...
    make sure your browser accepts the certificate presented by Veritawall, as it won't
