...
Setup Web Filtering
====================
Category based web filtering in Veritawall is done by utilizing the built-in proxy
...
Other popular lists that are expected to work well with Veritawall are:
