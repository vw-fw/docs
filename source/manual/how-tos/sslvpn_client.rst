...
* Easy setup on almost all mobile clients using Veritawall's Client Configuration Export.
* Fine grained access control by using multiple servers or Client Specific Overrides.
* No issues with NAT without NAT-T

With this how-to we'll show you how to configure Veritawall's SSL VPN for road warriors
...
Sample Setup
------------
For the sample configuration we configure Veritawall
 ...
 **City**                   *Middelharnis*
 **Organization**           *Veritawall*
 **Email Address**          *spam@veritawall.org*
...
Veritawall supports another layer, namely a user certificate. This means that every
