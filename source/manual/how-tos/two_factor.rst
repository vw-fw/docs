...
using Veritawall and Google's Authenticator. All services of Veritawall can be used
...
-----------------------
For testing the user authentication, Veritawall offers a simple tester.
