...
In Veritawall, port forwarding can be set up by navigating to :menuselection:`Firewall --> NAT --> Port Forward`. Here, you will see
...
.. Note:
   ...
   In Veritawall, this feature is also used to implement transparent proxies. A connection needs to be forwarded to a
...
In Veritawall, one-to-one NAT can be set up by navigating to :menuselection:`Firewall --> NAT --> One-to-one`. Here, you will see an
