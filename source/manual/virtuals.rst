...
Local/Server
------------
Installing Veritawall on a virtual machine can be done by using the DVD ISO image.
...
---
**i440FX chipset**
Veritawall on KVM works with virtio disks and network devices (confirmed on QEMU 5.0).

**Q35 chipset**
As of 22.1.x, Veritawall is based on FreeBSD 13.0, which includes support for the virtualized Q35 chipset and newer
...
Others
------
Veritawall can be installed on all virtual machines that support FreeBSD (such as Bhyve, VirtualBox).
...
approach is available in the form of **veritawall-bootstrap**.

veritawall-bootstrap
------------------
veritawall-bootstrap(8) is a tool that can completely reinstall a running system
in place for a thorough factory reset or to restore consistency of all the Veritawall
...
trust by using current package fingerprints -> CA root certificates -> HTTPS -> Veritawall
package fingerprints.

What it will also do is turn a supported stock FreeBSD release into an Veritawall
installation.  Both UFS and ZFS installations are supported.

veritawall bootstrap is available for our
...
Installing Veritawall into the Amazon cloud can be a daunting task as no console is
...
Veritawall is also available in the Microsoft Azure Marketplace as an easy installable virtual appliance.
...
Veritawall installation has a minimum of 1 GB of RAM.
