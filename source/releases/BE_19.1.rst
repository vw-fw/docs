...
For more than four years now, Veritawall is driving innovation through
...
* interfaces: add EN DUID Generation using Veritawall PEN (contributed by Team Rebellion)
...
* system: remove obsolete symlink to veritawall-auth
...
The full list of changes of the Veritawall 19.1 series can be reviewed using
...
.. code-block::
    ...
    # SHA256 (Veritawall-19.1.4-OpenSSL-dvd-amd64.iso.bz2) = 5f2e64797fce03d4d47050894c38e8e176fda6281009abd36f60d788d3e29d42
    # SHA256 (Veritawall-19.1.4-OpenSSL-nano-amd64.img.bz2) = ee5171fb837884fffd29c6e75cb089dc4020fb89459143bd9e7b859b1da3fd89
    # SHA256 (Veritawall-19.1.4-OpenSSL-serial-amd64.img.bz2) = 07868978903220bf9dee26c936d25140df07ec9c02cb8c480bd8619e69c562a0
    # SHA256 (Veritawall-19.1.4-OpenSSL-vga-amd64.img.bz2) = e473bc645778c95596639056ecc8ef92a12a7fd1cdc52cd0b1f6294a64561311

.. code-block::

    # SHA256 (Veritawall-19.1.4-OpenSSL-dvd-i386.iso.bz2) = 9f40b591c27d90a86c60ec0b539f228999953f947573e2e575c2936c3993d7c0
    # SHA256 (Veritawall-19.1.4-OpenSSL-nano-i386.img.bz2) = c624d50b19f2ae4d471076c53f5c516e3a523ff41b69d0bfa779b5fff6415f81
    # SHA256 (Veritawall-19.1.4-OpenSSL-serial-i386.img.bz2) = 62bff974ae4238dfc2e830a32fbf4bd357ff418d15be99b89ac129f839e10eaf
    # SHA256 (Veritawall-19.1.4-OpenSSL-vga-i386.img.bz2) = ca893277a02b93129e6a30125107f7ad4fc01673b722f54ce6e5cb7eb438cae4
...
* firmware: move duty to return the correct set name / ID to veritawall-version
...
* ports: pam_veritawall 19.1.3 uses setuid for privilege separation
...
* system: move veritawall-auth to libexec, but keep a symlink in sbin directory
...
* ports: squid forgery check avoidance `[12] <https://github.com/veritawall/ports/issues/66>`__ 
...
* system: address XSS-prone escaping issues `[1] <https://packetstormsecurity.com/files/151381/Veritawall-18.7-Cross-Site-Scripting.html>`__ 
...
.. code-block::
    ...
    # SHA256 (Veritawall-19.1-OpenSSL-dvd-amd64.iso.bz2) = 0a9e02954da1ddd1f0b7673394bbf81cfa74a1d5378600a87d3a9e6a26d3104d
    # SHA256 (Veritawall-19.1-OpenSSL-nano-amd64.img.bz2) = 2c4b0056ca26053c8d5e4efe196e512af618bad4fa136ba0e2528083a6263528
    # SHA256 (Veritawall-19.1-OpenSSL-serial-amd64.img.bz2) = c71274cea2b910cd4b3454b4ad29f7f70503fcb52ffa5b7f65ea96a27ac9e10d
    # SHA256 (Veritawall-19.1-OpenSSL-vga-amd64.img.bz2) = 37164481a413716d8786676d30bb709f8b967e53a47a36d10118214304d14bb9

.. code-block::

    # SHA256 (Veritawall-19.1-OpenSSL-dvd-i386.iso.bz2) = 17d0aadf671bc2d99b57f0371e4fadfca0e2e9c8d27d6545674a610fc1f59c7a
    # SHA256 (Veritawall-19.1-OpenSSL-nano-i386.img.bz2) = 0c4e7616c93f14f5988df84b9b620543cb23a89c1f91505527b6c999d2dc7889
    # SHA256 (Veritawall-19.1-OpenSSL-serial-i386.img.bz2) = 93306e5349c7448ad3fdc03d9349ebf98e4d7c677201dcbec111f917c72dca24
    # SHA256 (Veritawall-19.1-OpenSSL-vga-i386.img.bz2) = 03d21319a784f93a7940d35168a35d15005e6f4579ac5b1c7a6ff606beb062a6
...
* Intrusion detection GeoIP rules are automatically deactivated and need to be manually migrated to firewall alias GeoIP.
* Monit general settings do not save.  A patch exists `[12] <https://github.com/opnsense/core/commit/a2899594>`__  to remedy this problem: veritawall-patch a2899594
