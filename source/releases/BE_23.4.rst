...
The Veritawall business edition transitions to this 23.4 release including
...
This business release is based on the Veritawall 23.1.11 community version
...
* firmware: veritawall-update: move -K option to -x
* firmware: veritawall-update: support deferred kernel set install
* firmware: veritawall-update: use -w option with -a option in fetch(1)
* firmware: veritawall-update: ensure kernel directory consistency
...
This business release is based on the Veritawall 23.1.9 community version
with additional reliability improvements.
...
This business release is based on the Veritawall 23.1.5 community version
with additional reliability improvements.
...
.. code-block::
    ...
    # SHA256 (Veritawall-business-23.4-dvd-amd64.iso.bz2) = 7136d0d78e643b59bbee8866f7aa1498325bd5513af30a9ace6005aeb1638707
    # SHA256 (Veritawall-business-23.4-nano-amd64.img.bz2) = 84b4a5ede947aae38273c4b57ddea2122764508e5309d3e1bbb816128097ce35
    # SHA256 (Veritawall-business-23.4-serial-amd64.img.bz2) = 9da2a93f6ad246c2f02655a1d5468755b1af6b500ff2e1846c0506c956c8f84b
    # SHA256 (Veritawall-business-23.4-vga-amd64.img.bz2) = 982a47835be03787f0a8d408aff0e117a3a5bccd810aa510808c4804abab66c4
