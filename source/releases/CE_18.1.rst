...
* firmware: allow both origin.conf and Veritawall.conf to be used for repository setup
...
* console: manual pages for veritawall-importer and veritawall-installer
* console: let veritawall-installer set up an early runtime environment
* console: show firmware reboot hint prior to update when applicable
* console: longer timeout for veritawall-importer invoke on first boot
* console: proper return values for veritawall-importer in edge cases
...
Veritawall 17.7 and earlier.  The hardware-assisted VLAN capability
...
* firmware: let veritawall-patch apply chmod even in partially failed patches
* firmware: let veritawall-code fetch all remotes as well as prune them
...
Veritawall 18.1 images based on version 18.1.6.  Apart from the numerous
...
The full list of changes of the Veritawall 18.1 series can be reviewed
...
.. code-block::
    ...
    # SHA256 (Veritawall-18.1.6-OpenSSL-dvd-amd64.iso.bz2) = ee296edf026abd23b01d04c2aee7b9a0578ad4b3aa039e50eb40f720f13eac58
    # SHA256 (Veritawall-18.1.6-OpenSSL-nano-amd64.img.bz2) = 204e87a93b5bd0f7742e90bef8ae20bfd7c362a73ee29054a96356e9649572b3
    # SHA256 (Veritawall-18.1.6-OpenSSL-serial-amd64.img.bz2) = 063dc97b4177a932ba0bb243bec54b6b568ed84e515445b3eae7ba54f087478f
    # SHA256 (Veritawall-18.1.6-OpenSSL-vga-amd64.img.bz2) = 9be03dccce94705c35c476ea7ca0e2f42c70049ecc5c681a6dfe92b7f21d7c34

.. code-block::

    # SHA256 (Veritawall-18.1.6-OpenSSL-dvd-i386.iso.bz2) = 06883a48295529bb7fae9fff4a77bbb95df9fcb08554f4c73aa3e0b894a4158b
    # SHA256 (Veritawall-18.1.6-OpenSSL-nano-i386.img.bz2) = ea87270fb5c83943c7cccae12ae9579f4f3a82489a901881cd4a786b7e09009d
    # SHA256 (Veritawall-18.1.6-OpenSSL-serial-i386.img.bz2) = 3ccbdf4fd31913afc93b0b51b4784df01d22ec03156659efe78d36ab2dcf222f
    # SHA256 (Veritawall-18.1.6-OpenSSL-vga-i386.img.bz2) = 252b16aae7592faf3d5912b5394124e494db7797ebeec7d6b7fae9a52ad28cd4
...
* firmware: fix veritawall-code for src.git and ABI probing
* firmware: fix veritawall-patch file permission apply for plugins
...
.. code-block::
    ...
    # SHA256 (Veritawall-18.1-OpenSSL-dvd-amd64.iso.bz2) = 3988c506c818c0861bb9beb38166123e9aca0814c0ef508779c1ebe9a8400c9c
    # SHA256 (Veritawall-18.1-OpenSSL-nano-amd64.img.bz2) = ab284cfd62f095b8f745604099ee8b4f0b5cda06ec67ec72a3ffa921328635d5
    # SHA256 (Veritawall-18.1-OpenSSL-serial-amd64.img.bz2) = 31eb6f7c44126258eb1b062d44dd92b1b0e3ebf57777c899f2df8858e5321b13
    # SHA256 (Veritawall-18.1-OpenSSL-vga-amd64.img.bz2) = 714b347c3c62a9a1178f0b77661fa7e7ad8b0d06c1e174af1085fda761639505

.. code-block::

    # SHA256 (Veritawall-18.1-OpenSSL-dvd-i386.iso.bz2) = 10d27b8d0e5b4dde46be413088440db47e49f4eea3de53cc7339976c6471d26a
    # SHA256 (Veritawall-18.1-OpenSSL-nano-i386.img.bz2) = 5c4289940f4c7f03eaf4c00d3b673bc85cb366a5f12334d00d19183dbafc221b
    # SHA256 (Veritawall-18.1-OpenSSL-serial-i386.img.bz2) = ff63e759cdab3960119db159141a96f7e98ed0a427621585edc8362b9abf7a33
    # SHA256 (Veritawall-18.1-OpenSSL-vga-i386.img.bz2) = c43712c87a3381102d33f2606fc666fdffde54d81a0f0b8c70cf334eddd4047c
...
* network time: Veritawall NTP pool is now available and used in default configuration
