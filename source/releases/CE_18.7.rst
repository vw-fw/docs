...
* ZFS on root boot support (installer support is pending, but veritawall-bootstrap works)
...
* firmware: migrate more scripting to veritawall-version
...
* firmware: veritawall-version can now handle kernel, base and plugin metadata
...
* system: do not offer root-only veritawall-shell to non-root users
...
* firmware: use veritawall-version where appropriate
...
* firmware: introduce veritawall-version utility and fully template build metadata
...
* SSH access is now bound to the "wheel" group which is automatically
  ...
  only user that has a default shell, namely veritawall-shell, which is the
  root console menu.
...
.. code-block::
    ...
    # SHA256 (Veritawall-18.7-OpenSSL-dvd-amd64.iso.bz2) = 6b3528f8dea8de5c96de5547636fd51c40382c245b30eb215608acbd04fb7e91
    # SHA256 (Veritawall-18.7-OpenSSL-nano-amd64.img.bz2) = cb0272f0bd945ea8070d9a40af2cd47a3b68e9bd389395b285bb9ab4128d1f00
    # SHA256 (Veritawall-18.7-OpenSSL-serial-amd64.img.bz2) = a4556080532d22e9ab296e2c6e163b3d65d5fe54a642253e1c01a22721afa850
    # SHA256 (Veritawall-18.7-OpenSSL-vga-amd64.img.bz2) = 4408840fba4177d44503968fce44d8ca7180003728660fd9c0a2e6920346008c

.. code-block::

    # SHA256 (Veritawall-18.7-OpenSSL-dvd-i386.iso.bz2) = 8ea49dcb512365a1e92e94fb38f1b4a85463ffacfb98c055e84e6340a6321ecf
    # SHA256 (Veritawall-18.7-OpenSSL-nano-i386.img.bz2) = bdd753a63367944452d2d5d1e73e4aa9f3d607012d10c4274420d23867a4fbad
    # SHA256 (Veritawall-18.7-OpenSSL-serial-i386.img.bz2) = f74f5fd1c24cc54002fa9b99a0c10b4402b3f748a315ff302126acb154cd2633
    # SHA256 (Veritawall-18.7-OpenSSL-vga-i386.img.bz2) = 52208b57f9e89d235411df33faac71b8d9872d50947ff4c0dca6f552424a4d95
...
* installer: use veritawall-importer on configuration import to avoid code duplication
...
* rc: redesigned rc.initial as veritawall-shell utility with command line support and improved RC system interoperability
