...
For five and a half years, Veritawall is driving innovation through modularising
...
* firmware: veritawall-code now updates the current directory if nothing was specified
* firmware: veritawall-code now uses flexible make.conf target from tools.git
* firmware: veritawall-update now supports snapshot access via -z option
* firmware: veritawall-update now fixes missing dependencies on the fly
...
.. code-block::
    ...
    # SHA256 (Veritawall-20.7-OpenSSL-dvd-amd64.iso.bz2) = 580070a3a0533418d58eaeb78122f804f2df7081c929288e1dccee34c4bf763a
    # SHA256 (Veritawall-20.7-OpenSSL-nano-amd64.img.bz2) = 6deb370c2a64fa6c60b7f59a4afb31b2dd28b812f5fcd59eaa6d458938d45630
    # SHA256 (Veritawall-20.7-OpenSSL-serial-amd64.img.bz2) = 1276cddd5f7b89aa54fc4a1517cb0686efe94f672627243c5b34d93340441d60
    # SHA256 (Veritawall-20.7-OpenSSL-vga-amd64.img.bz2) = 72cbffe3bba4884586c8ded8dbca4cf30fb34a094602e5f681efde2deea595c6
...
.. code-block::
    ...
    # SHA256 (Veritawall-20.7.r1-OpenSSL-dvd-amd64.iso.bz2) = d54dca6390497d45b831f68f352fccf84881aac78a360247965e5c9b36fbfded
    # SHA256 (Veritawall-20.7.r1-OpenSSL-nano-amd64.img.bz2) = f78d51d53bf663df2d49a3724812893d8c55234ab8d4a9232663fa581496edbe
    # SHA256 (Veritawall-20.7.r1-OpenSSL-serial-amd64.img.bz2) = 984f8c9d63598f061cc8995245dea73703532c1bb688ac87cdb1e510fb53b80e
    # SHA256 (Veritawall-20.7.r1-OpenSSL-vga-amd64.img.bz2) = 711811e0a7d37d323a060c52590daa9f024e77c6da627530c6596367a09b412d
