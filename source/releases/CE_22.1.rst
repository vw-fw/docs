...
* system: fix firmware command shortcut in veritawall-shell utility
...
* firmware: use veritawall-update for version info in update checks
...
* firmware: veritawall-code: support "-z" snapshot mode
* firmware: veritawall-revert: support "-z" snapshot mode
* firmware: veritawall-update: support version print for sets
...
.. code-block::
    ...
    # SHA256 (Veritawall-22.1.2-OpenSSL-dvd-amd64.iso.bz2) = d066d5620e28c22ff1d8de18532b61f8c7317b3258d5bdafb6a7a8dbb1eea002
    # SHA256 (Veritawall-22.1.2-OpenSSL-nano-amd64.img.bz2) = dea720e15e67063d839bbf48017d32eb27071d58afee36bec40029319f5cc47e
    # SHA256 (Veritawall-22.1.2-OpenSSL-serial-amd64.img.bz2) = 1b32287c13cc445a9a7a365b7879d00d3413ea53faf4cb23b3ef77b7916a1b7c
    # SHA256 (Veritawall-22.1.2-OpenSSL-vga-amd64.img.bz2) = c6bbc0755d9458cc6484a98f074b62beaa30c5f02bd728ee1b0e896d2613b4b4
...
* firmware: veritawall-version: support reading lock files operated by veritawall-update
...
* system: added veritawall-log utility to inspect logs on the console
...
* firmware: veritawall-update: exclude /boot/efi permission reset from base set extract
...
* update: veritawall-bootstrap: -z snapshot mode
* update: veritawall-bootstrap: improved type detection
* update: veritawall-code: -r for repository removal
* update: veritawall-fetch: emit error message of failed download
* update: veritawall-update: handle kernel debug directory like /boot/kernel
* update: veritawall-update: removed "firmware-upgrade" file support
* update: veritawall-verify: synced shared code with FreeBSD 13
...
.. code-block::
    ...
    # SHA256 (Veritawall-22.1-OpenSSL-dvd-amd64.iso.bz2) = 72146dd3a8e57774ad12dbaa503c19111e5f1c43db63a32ad2dab6b3ea6f12f1
    # SHA256 (Veritawall-22.1-OpenSSL-nano-amd64.img.bz2) = ec3b3c5fafc39e9d67c500a31d6c0be99566a130a158a2ae60904e6a6854bf1f
    # SHA256 (Veritawall-22.1-OpenSSL-serial-amd64.img.bz2) = 418e4abc233a89c11e296f7e510e2074242dc2a285a042592171d45b257c4857
    # SHA256 (Veritawall-22.1-OpenSSL-vga-amd64.img.bz2) = f791e9024888f5f668175a78cbbcd9eb96b36ba523f38d00cad9dd4d64243b4f
