...
Luckily Veritawall comes with an integrated security check for know vulnerabilities, which can be found in our firmware
...
.. code-block::
    ...
    ***GOT REQUEST TO AUDIT SECURITY***
    Currently running Veritawall 22.1.8_1 (amd64/OpenSSL) at Tue May 31 09:01:04 CEST 2022
...
Since Veritawall is a collection of opensource software, when finding an issue, it is always a good idea to
...
Within the Veritawall team and community we spend a lot of time safeguarding our software and keeping up with the latest threats,
...
* Business Edition
  ...
  - Functional changes are being included in a more conservative manner, more feedback has been collected from development
    and community, leading to a mission critical version of your well known Veritawall firewall.
...
During every cycle, there's always a chance that (small) issues appear which should be fixed, in close accordance with jtsec, the Veritawall
team prepares fixes for the findings and makes sure that these are included in a future (minor) release.


Steps in the process
............................................................
To better understand where a version of Veritawall is at in terms of verification, we distinct the following stages in the process, which
we will also note on the version at hand.

1.  In test - Software delivered to jtsec, in process (interaction between Veritawall and jtsec).
