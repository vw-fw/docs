...
In case your issue was introduced after a (minor) upgrade, you can use `opnsense-revert <https://docs.opnsense.org/manual/_tools.html#opnsense-revert>`__
...
.. code-block:: text
    ...
    ***GOT REQUEST TO AUDIT HEALTH***
    ...
    veritawall-19.7.4_1: checksum mismatch for /usr/local/etc/inc/auth.inc
    Checking all packages...
    Checking all packages......... done
    ***DONE***

When mismatches are reported, you can reinstall affected packages in the **Packages** section of the firmware screen.
In the case above you would reinstall veritawall, since the :code:`auth.inc` looks tainted.
